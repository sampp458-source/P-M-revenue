...
describe('Directory and catalog V2 presentation boundary',()=>{
 ...
 const s=normalizeVisualSystemD(readFileSync('src/pages/CustomerManagement.tsx','utf8')).replace(/import "\.\.\/(?:design-system-v2|directory-design-v2|catalog-design-v2)\.css";\n/g,'').replace(/ pm-design-v2 pm-(?:directory|catalog)-v2/g,'');
 ...
 const s=normalizeVisualSystemD(readFileSync('src/pages/DogManagement.tsx','utf8')).replace(/import "\.\.\/(?:design-system-v2|directory-design-v2|catalog-design-v2)\.css";\n/g,'').replace(/ pm-design-v2 pm-(?:directory|catalog)-v2/g,'');
 ...
 const s=normalizeVisualSystemD(readFileSync('src/pages/ProductManagement.tsx','utf8')).replace(/import "\.\.\/(?:design-system-v2|directory-design-v2|catalog-design-v2)\.css";\n/g,'').replace(/ pm-design-v2 pm-(?:directory|catalog)-v2/g,'');
 ...
 const s=normalizeVisualSystemD(readFileSync('src/pages/Management.tsx','utf8')).replace(/import "\.\.\/(?:design-system-v2|directory-design-v2|catalog-design-v2)\.css";\n/g,'').replace(/ pm-design-v2 pm-(?:directory|catalog)-v2/g,'');
