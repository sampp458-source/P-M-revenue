...
describe('Calendar V1 visual boundary', () => {
  it('keeps material adoption isolated to Calendar, Hotel and Today pages', () => {
    ...
    expect(pages.filter(name => readFileSync(`src/pages/${name}`, 'utf8').includes('pm-design-v1'))).toEqual(['HotelOperations.tsx', 'OperationsCalendarFoundation.tsx', 'OperationsToday.tsx']);
  });
