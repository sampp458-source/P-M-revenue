...
export function ReportsPage() {
  ...
  const report = useMemo(() => {
    ...
    return {
      total: money.salesAmount, paid: cash.paidAmount, real: cash.netAmount, refund: cash.refundAmount, outstanding: money.outstandingAmount,
