-- Minimal lock-order repair for the existing Hotel reservation update RPC.
-- Semantic contract is unchanged; only Type -> Room advisory lock order changes.
...
begin
  ...
  if target_body_fingerprint <> '11bfba2f2cf38dc814908bff25e38f8f' then
    raise exception 'STOP_UPDATE_HOTEL_RESERVATION_UNEXPECTED_VERSION'
      using detail = format(
